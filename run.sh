...
python main.py --base composite --bayes_opt --data_splitter StressCycleSplitter --investigate_clustering

python main.py --base composite --bayes_opt --data_splitter StressCycleSplitter --split_ratio 0.3 0.1 0.6 --investigate_clustering
python main.py --base composite --bayes_opt --data_splitter RandomSplitter --split_ratio 0.3 0.1 0.6 --investigate_clustering
