...
trainer_analysis = load_trainer(
    "output/composite_database_03222024/2024-04-16-23-10-09-0_composite A622 mcd analysis/trainer.pkl"
)
...
with open(os.path.join(trainer.project_root, "shap_train.pkl"), "wb") as file:
    pickle.dump(
